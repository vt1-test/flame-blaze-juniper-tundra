...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ChVPxijy.mjs");
...
var manifest = {
	"077a846cca3bb8ab888f44d96ca4a79bf024d0933f334843dd6983e357ce8a9f": {
		functionName: "submitAttempt_createServerFn_handler",
		importer: () => import("./attempts-Da6jhkFs.mjs")
	},
	"2c71ff9fb3b431ed0063d78c8964e600fcd964dba9ced7477f64bc11db77de02": {
		functionName: "listMyAttempts_createServerFn_handler",
		importer: () => import("./attempts-Da6jhkFs.mjs")
	},
	"45be628f1c4eff09ecfb5ab3fca6fc11f77590d8d8dbcdd6200ee279086ad344": {
		functionName: "listStandings_createServerFn_handler",
		importer: () => import("./attempts-Da6jhkFs.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-LT7cGoZx.mjs").then((n) => n.t),
